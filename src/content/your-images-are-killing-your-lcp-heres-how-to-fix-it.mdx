export const metadata = {
  ...
  ogImage:
    "https://res.cloudinary.com/dif39heof/image/upload/v1771087237/blogs/thubnail.webp",
  summary:
...
![LCP waterfall breakdown showing resource load timing in Chrome DevTools](https://res.cloudinary.com/dif39heof/image/upload/v1771150834/lcp_vkoz9o.webp)
...
Only use orientation switching when the design actually needs different crops.
Don't add it everywhere it's extra work for minimal gain in most cases.
