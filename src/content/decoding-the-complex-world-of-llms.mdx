export const metadata = {
  ...
  date: "2025-10-19",
  tags: ["llms", "ai", "ai-race"],
  ogImage:"https://yagyaraj.com/post/decoding-the-complex-world-of-llms/og.png",
  summary: "Ever feel lost in the AI race, confused by LLMs jargon like tokens, temperature and vectors? This blog will break down all the confusing LLM jargon into simple terms.",
};
