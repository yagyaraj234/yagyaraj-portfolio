export const metadata = {
  title: "You Don't Know useRef Hook Yet: Beyond DOM Access in React",
...
Trying to represent things like focus, scroll position, or cursor location with state usually creates more problems than it solves. React is declarative, but the browser is imperative. Some things need to be told what to do, not described.
...
This is where useRef shows its real value.
