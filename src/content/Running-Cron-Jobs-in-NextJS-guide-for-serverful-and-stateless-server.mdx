export const metadata = {
  title:
    "Running Cron Jobs in Next.js: Complete Guide for Serverful and Serverless Deployments",
  author: "Yagyaraj Lodhi",
  date: "2026-01-03",
  tags: ["nextjs", "cron", "serverful", "serverless", "vercel", "node-cron"],
  ogImage:
...
In simple terms any repetitive task we want to do at a specific interval, we set up a cron job for it.
