...
function BlogItem(props: BlogItemProps) {
  return (
    <Link
      href={props.url}
      className="group flex w-full items-start justify-between border-b border-gray-200 sm:py-2.5 py-2.5 transition-all duration-700 ease-in-out hover:border-gray-400 sm:items-center"
    >
